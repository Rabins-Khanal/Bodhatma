      ...
      <div className="m-4 md:w-1/2">
        {!data.uploadSliderBtn ? (
          <div
            ...
            className="cursor-pointer rounded-full p-2 flex items-center justify-center text-white text-sm font-semibold uppercase hover:opacity-90 transition"
          >
            <svg
    ...
    <Fragment>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-4">
        {data.sliderImages.length > 0 ? (
          data.sliderImages.map((item, index) => (
            <div key={index} className="relative col-span-1 m-2 border">
              ...
              <span
                ...
                style={{ background: "#FA8256" }}
                className="absolute top-0 right-0 m-1 text-white cursor-pointer rounded-full p-1 hover:opacity-90 transition"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-3 text-center text-xl font-light w-full bg-orange-100 rounded py-2 text-orange-800">
