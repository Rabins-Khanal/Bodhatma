  ...
  return (
    <Fragment>
      ...
      >
        ...
        {/* Scriptures (Unclickable) */}
        <div
  className="flex flex-col items-center justify-center py-6 cursor-default text-black-400"
  title="Scriptures"
>
  <span>
    {/* Book icon */}
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 6v12m-6-9h12a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6a2 2 0 012-2z"
      />
    </svg>
  </span>
